...
%% 2. Data Definitions
baseFilepath = 'Paper Figures/9 Verification/';
...
imageVector = baseFilepath + "printims/marked up/" + {
    's1m2v.png', ...
    's1m2p.png', ...
    's2m2v.png', ...
    's2m2p.png', ...
...
% --- SAVE FIGURE ---
savefig(f,baseFilepath + 'Figure9.fig')
exportgraphics(f,baseFilepath + 'Figure9.png','Resolution',600);
exportgraphics(f,baseFilepath + 'Figure9.eps','ContentType','vector')
