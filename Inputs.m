...
if method==1
    ...
    m=11; % If doing a simulation, program will test bezier fitting for n:1:m in parallel
...
dataA = readtable(strcat('Data/CT Scans/',SurfA));
dataA.Properties.VariableNames={'x','y','z'};
dataB = readtable(strcat('Data/CT Scans/',SurfB));
